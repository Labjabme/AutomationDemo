...
import pageObjects.ProductFleeceJacketPage;
...
/*    @BeforeTest
    ...
    public void assertFleeceJacketLabel(String Username, String Password) throws IOException {
       ...
       /* if (Username == "locked_out_user") {
        ...
        if (Username == "problem_user") {
            ...
            String getPrice = fleeceJacketLabel.assertFleeceJacket().getText();
            System.out.println(getPrice);
            Assert.assertEquals(getPrice, "$√-1");
            driver.close();
